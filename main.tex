...
\begin{itemize}
    \item \AGSNote{Change $d_{\bX}$ to $d$?}
    \item \AGSNote{Bayesian Posterior mean use $\beta$ and $b$ instead of $\bS$}
    ...
    \item \AGSNote{change \emph{crude} to \emph{simple} or \emph{IID} Monte Carlo}
